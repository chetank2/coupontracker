...
/**
 * Conservative field-level merger for OCR/default and VLM outputs.
 *
 * Rules here intentionally prevent model output from overwriting
 * OCR-anchored values unless there is corroborating evidence.
 */
object VlmMerger {
