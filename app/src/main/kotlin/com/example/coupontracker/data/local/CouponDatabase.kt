...
abstract class CouponDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Migration from version 3 to 4 (adding deduplication metadata columns)
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE coupons ADD COLUMN normalizedDescription TEXT")
                database.execSQL("ALTER TABLE coupons ADD COLUMN descriptionHash TEXT")
                database.execSQL("ALTER TABLE coupons ADD COLUMN descriptionSignature TEXT")
